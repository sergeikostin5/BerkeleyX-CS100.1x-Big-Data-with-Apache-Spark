...
# TODO: Replace <FILL IN> with appropriate code
wordPairs = wordsRDD.map(lambda key: (key, 1))
...
def wordCount(wordListRDD):
    ...
    """
    wordPairs = wordsListRDD.map(lambda key: (key, 1))
    wordCounts = wordPairs.reduceByKey(add)
    return wordCounts
...
# TODO: Replace <FILL IN> with appropriate code
shakeWordsRDD = shakespeareRDD.flatMap(lambda line: line.split())
...
# TODO: Replace <FILL IN> with appropriate code
wordPairs = shakeWordsRDD.map(lambda key: (key, 1))
wordCounts = wordPairs.reduceByKey(add)
top15WordsAndCounts = wordCounts.takeOrdered(15, lambda (k,v): -v)
